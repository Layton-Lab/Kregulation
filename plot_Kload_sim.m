...
if plt_means
    ...
    hold on
    plot(s, max_vals(:,1), 'color', c1, 'marker', m1, 'linestyle', 'none');
    %plot(s, min_vals(:,1), 'color', c1, 'marker', m1, 'linestyle', 'none');
    plot(s, mean_vals(:,2), 'Linewidth', lw, 'color', c2, 'marker', m2);
    plot(s, max_vals(:,2), 'color', c2, 'marker', m2, 'linestyle', 'none');
    plot(s, mean_vals(:,3), 'Linewidth', lw, 'color', c3, 'marker', m3);
    plot(s, max_vals(:,3), 'color', c3, 'marker', m3, 'linestyle', 'none');
    plot(s, mean_vals(:,4), 'Linewidth', lw, 'color', c4, 'marker', m4);
    plot(s, max_vals(:,4),  'color', c4, 'marker', m4, 'linestyle', 'none');
    yline(5.0, 'Linewidth', 1.5, 'color', 'k', 'linestyle', '--');
    yline(3.5, 'Linewidth', 1.5, 'color', 'k', 'linestyle', '--');
    xlabel('time (days)', 'fontsize', f.xlabel)
    ylabel('plasma [K^+] (mEq/L)', 'fontsize', f.ylabel)
    xlim([1,14])
    hold off
